...
const MyStore = ({name}) => {
    ...
    return (
        <div>
            ...
            <p className="text-xl text-black-800 font-bold w-full mx-auto mb-10">Welcome to your dashboard, Micheal</p>
            ...
            <div className='flex justify-between w-full'>
                <div className='w-1/2'>
                    ...
                    <div className="flex justify-between w-full">
                        ...
                        <Total image={total_orders} type ={"orders"} number={storeData.totalOrders}></Total>
                    </div>
                </div>
...
const Today = ({image, type, number, storeData}) => {
    return (
        <div className="bg-white shadow-lg rounded-lg py-4 mx-1 pl-3 w-1/3">
            <div className='rounded-full bg-blue-100 py-3 w-1/3'>
