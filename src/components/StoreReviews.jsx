...
const StoreReviews = () => {
    ...
    const [storeReviews, setStoreReviews] = useState([0]);
...
const Children = ({id, reviews, ratings, date}) => {
    ...
    return (
        <div className="flex justify-between">
            ...
            <p className='text-xs my-auto'>{reviews}</p>
            <p className='text-xs my-auto'>{ratings}</p>
            ...
            <span onClick={handleClick}>
                ...
                <div className={currentState ? 'rounded bg-white shadow-lg py-2 px-2 relative' : 'hidden'}>
                    <p className='text-xs my-auto my-2'>View Review</p>
