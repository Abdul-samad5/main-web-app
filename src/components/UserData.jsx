        ...
        <div className="rounded shadow-xl w-4/5 px-5 py-3 mx-auto my-auto h-auto ">
            ...
            <div className='flex justify-between mt-10 align-center'>
                <span className='flex justify-between'>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" className='w-2 h-4 fill-slate-400'><path d="M137.4 41.4c12.5-12.5 32.8-12.5 45.3 0l128 128c9.2 9.2 11.9 22.9 6.9 34.9s-16.6 19.8-29.6 19.8H32c-12.9 0-24.6-7.8-29.6-19.8s-2.2-25.7 6.9-34.9l128-128zm0 429.3l-128-128c-9.2-9.2-11.9-22.9-6.9-34.9s16.6-19.8 29.6-19.8H288c12.9 0 24.6 7.8 29.6 19.8s2.2 25.7-6.9 34.9l-128 128c-12.5 12.5-32.8 12.5-45.3 0z"/></svg>
                </span>
                {
                    infoHead.map((word, index) => {
                        return  <p key={index} className="text-sm">{word}</p>
                    })
                }
            </div>
            ...
            <div className='mt-3'>
                ...
                <img src={image} alt="No customer found" className={data.length === 0 ? 'mx-auto w-auto h-auto' : 'hidden'} />
                <p className={data.length === 0 ? 'text-base text-center' : 'hidden'}>{`No ${type} found`}</p>
            ...
            <div className='flex justify-between mt-10 align-center'>
                ...
                <span className='flex justify-between'>
                    <p className={data.length === 0 ? 'text-xs text-slate-400 hidden' : 'text-xs text-slate-400'}>Showing 1 to 5 of 5 entries</p>
                    <p className={data.length === 0 ? 'text-xs text-slate-400' : 'text-xs text-slate-400 hidden'}>Showing 0 to 0 of 0 entries</p>
                    <p className='text-blue-700 text-xs mx-2'>{currentPage}</p>
                    <span onClick={handleClick}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" className='w-4 h-4 fill-slate-300' ><path d="M342.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L274.7 256 105.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"/></svg>
                    </span>
                    
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className='w-4 h-4 fill-slate-300'><path d="M470.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 256 265.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160zm-352 160l160-160c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L210.7 256 73.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0z"/></svg>
                </span>
