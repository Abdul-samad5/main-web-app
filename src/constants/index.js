...
const styles = {
  button:
    "py-[10px] w-full flex justify-center px-[32px] bg-brand-primary hover:cursor-pointer text-white rounded-[8px] hover:bg-brand-secondary transition:colors duration-500",
  buttonOutline:
  ...
  stepFormHBox:
    "border border-[#CACACA] py-[40px] mb-[40px] max-w-[700px] mx-auto",
  stepFormVBox:
    "flex flex-col md:flex-row border border-[#CACACA] mb-[40px] max-w-[700px] mx-auto py-[40px] md:py-0",
  radioLabel:
    "flex items-center gap-[12px] border-b px-[16px] md:px-[40px] pb-[40px] mb-[40px]",
