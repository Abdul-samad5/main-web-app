...
const token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0b2tlbl90eXBlIjoicmVmcmVzaCIsImV4cCI6MTY3MjMxMzAwOSwiaWF0IjoxNjcyMjI2NjA5LCJqdGkiOiIzZjk4YzI0MDUwODQ0ZDNkYThhMzE4NzJkOTkwMzYwYSIsInVzZXJfaWQiOjh9.IpchFx1iDyInfonqMNVIWwqjstsg1_nu0arWpLDsYR8"
...
// Store endpoint
const postStore = (store) => axios.post(`${BASE_URL}store/create_store`, store, config);
...
export { 
  ...
  getProducts, addCollection, deleteCollection, 
  updateCollection, getCollection, getCollectionList, 
  getProductItemUnit, deleteItemUnit, updateItemUnit, 
  getProductItemUnitById, getProductList, deleteProduct, updateProduct
};