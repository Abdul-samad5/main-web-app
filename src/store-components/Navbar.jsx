...
const Navbar = ({
  ...
  return (
    <div className="z-10 bg-gray-100 shadow-sm lg:flex lg:justify-between sticky py-6 lg:py-0 z-30 top-0 px-10 lg:px-20 w-full">
      ...
      <ul
        className={`lg:flex list-none mt-10 lg:mt-0 w-auto py-1 lg:block ${
          dropDown ? "" : "hidden"
      ...
      >
        ...
        <li
          className="pb-[15px] px-6 group hover:bg-gray-300 flex justify-center align-center place-content-center hover:cursor-pointer"
          onClick={() => {
