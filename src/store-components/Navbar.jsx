            ...
            <div class="hidden sm:ml-6 sm:block">
              <div class="flex space-x-4">
                <Link to={"/store-front"} className="flex items-center">
                  <span className="self-center text-white text-md md:text-2xl font-semibold whitespace-nowrap ">
                    {storeName}
                  </span>
                </Link>
              </div>
          ...
          <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            <div class="relative ml-3">
              <div>
                ...
                >
                  <img class="h-8 w-8 rounded-full" src={storeLogo} alt="" />
                </button>
              </div>

              <div
                class={`right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 ${
                  dropDown ? "absolute" : "hidden invinsible"
