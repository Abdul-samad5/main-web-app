        ...
        <div>
            ...
            <div className='px-20 py-10 lg:flex lg:justify-between lg:gap-10 w-full h-auto'>
                ...
                <div className={`lg:w-1/2 w-full h-[450px] flex justify-center align-center rounded-lg shadow-lg border border-slate-100 bg-gray-100`}>
                    ...
                    <img src={productDetails?.media} className="my-auto w-[200px] border border-gray-200 h-[200px]"/>
                </div>
                ...
                <div className='lg:w-1/2 w-full px-4'>
                    ...
                    <div className='my-10'>
                        ...
                        <div className="flex justify-center mb-2">
                            <p onClick={() => setQuantity(prev => prev - 1)} className={"relative text-3xl text-brand-primary font-bold left-6 top-1 cursor-pointer"}>-</p>
                            <input className={`${styles.inputBox} rounded-full text-center`} value={quantity}/>
                            <p onClick={() => setQuantity(prev => prev + 1)} className={"relative text-3xl text-brand-primary font-bold right-6 cursor-pointer"}>+</p>
                            <p className='text-xs text-black opacity-60'>{`Only ${productDetails.stock_count} left. Don't miss it!`}</p>
                        </div>
