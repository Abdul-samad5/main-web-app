...
const DisplayProducts = ({
  ...
  return (
    <div className='group rounded w-full z-1 mb-10'>
      <div
        className={`w-full h-[250px] flex justify-center align-center rounded shadow-base border border-slate-100 bg-gray-100`}
      >
        <Link to={`/store-front/${id}`}>
          <img
            src={productLogo}
            alt='Logo'
            className='w-20 my-auto h-20 relative'
          />
        </Link>
      </div>

      <div className='group-hover:visible relative group bottom-[240px] left-[200px] shadow-lg grid place-content-center bg-white hover:bg-brand-primary w-8 h-8 rounded-full'>
        <svg
